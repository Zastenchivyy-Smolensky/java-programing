...
public class Ensyu0302 extends JFrame implements ActionListener {
	...
	Ensyu0302(){
		...
		bt1 = new JButton("数あて");bt1.addActionListener(this); p2.add(bt1);
		lb1 = new JLabel("");
		p2.add(lb1);
		c.add(new JLabel("数あてゲーム(20c2007影山亮太)"),BorderLayout.NORTH);
